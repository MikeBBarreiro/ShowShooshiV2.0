...
(function(){
  ...
  $(document).ready(function(){
    $('#toggle_userSearchChinese').click(geocode);
    $('#toggle_userSearchChinese').click(function(){
      var chinese = $(".Sushi").attr('src',"assets/img/chinees-show.png");
      chinese.addClass('animated zoomIn');
    });
  });
  ...
  function createMarker(place){
    ...
    marker = new google.maps.Marker({
      icon: 'assets/img/chinese-marker.png',
      map: map,
